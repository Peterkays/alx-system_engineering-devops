...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_instantiation_with_kwargs(self):
        ...
        cty = City(id="345", created_at=dyt_tm_iso, updated_at=dyt_tm_iso)
        self.assertEqual(cty.id, "345")
        self.assertEqual(cty.created_at, dyt_tm)
        self.assertEqual(cty.updated_at, dyt_tm)
    ...
    def test_str_representation(self):
        ...
        cty = City()
        cty.id = "123456"
        cty.created_at = cty.updated_at = dyt_tm
        ctystr = cty.__str__()
        self.assertIn("[City] (123456)", ctystr)
        self.assertIn("'id': '123456'", ctystr)
        self.assertIn("'created_at': " + dyt_tm_repr, ctystr)
        self.assertIn("'updated_at': " + dyt_tm_repr, ctystr)
